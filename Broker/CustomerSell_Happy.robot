...
${url_BUY}      #/jedi/customerexecutebuy
${url_SELL}     #/jedi/customerexecutesell
...
## BUY ##
${inputDDL_CTMonth}     xpath=//*[@id="sell"]/form/div[1]/div[2]/select
${input_Amount}         xpath://*[@id="sell"]/form/div[2]/div[2]/input
${btn_Buy}              xpath://*[@id="sell"]/form/div[6]/button[1]
...
Step : Customer Sell
    ...
    Click Element     xpath=//*[@id="pills-profile-tab"]
    Location Should Be  ${url_SELL}
    ...
    Sleep   1s
    Wait Until Page Contains          Selling Detail   40s
    Sleep   1s
    Capture Page Screenshot    1.Customer SELL-{index}.png
    Logout JEDI
