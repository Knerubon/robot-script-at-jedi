...
*** Test Cases ***
Step : Customer BUY
    login JEDI    ${input_user}    ${input_pass}     customer004     P@ssw0rd
...
#     Sleep  2s
#     Capture Page Screenshot  4.KTB Approve-{index}.png
